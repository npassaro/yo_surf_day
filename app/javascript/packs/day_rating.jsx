...
export function DayRating({ onChange, rating, possibleRatings }) {
    ...
    const iconClassName = (isChecked) =>
        isChecked ? 'DayRating_icon DayRating_icon--isChecked' : 'DayRating_icon';
        ...
        <label key={possibleRatings[possibleRatingKey].value}>
            <SurfIcon
                className={iconClassName(
                    isChecked(rating, possibleRatings[possibleRatingKey].value)
                )}></SurfIcon>
            <input
                type="radio"
